  ...
  render() {
    ...
    return (
      <Row gutter={24} style={{ marginBottom: 30 }}>
        <Col lg={14} md={12}>
          <Card bodyStyle={bodyStyle} title={<div style={titleStyle}>{i18n.t`安全趋势`} 
          {/* <RangePicker className={styles.date} allowClear format="YYYY-MM-DD" onChange={this.handleChange.bind(this, 'createTime')} /> */}
          </div>}>
            {/*<ReactEcharts ref="create_day" option={create_day} />*/}
            <Completed onClick={this.getChart} data={safety_Trend} inactive={this.state.inactive} getChart={this.getChart} />
          </Card>
        </Col>
        <Col lg={10} md={12}>
