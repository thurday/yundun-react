...
class Filter extends Component {
  ...
  render() {
    ...
    const uploadProps = {
      name: 'file',
      action: window.ip+'/localMaintenance/upgradeNowShou',
      headers: {
    ...
    const uploadUnProps = {
      name: 'file',
      action: window.ip+'/localMaintenance/upgradeAllShou',
      headers: {
        authorization: 'authorization-text',
      },
      onChange(info) {
        ...
        <Form layout="horizontal" className={styles.form}>
          ...
          <FormItem label={i18n.t`更新管理`} {...formItemLayout}>
            ...
            <div>
              ...
              <Upload {...uploadUnProps}>
                <Button type="primary"><Icon type="vertical-align-bottom" />手动统一升级</Button>
              </Upload>
            </div>
          </FormItem>
