  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        key: 'time',
        width: 'auto',
        render: (text, record, index) => renderEl(text ? text : '-', record, index),
      },
      {
      ...
      },
      {
        ...
        width: '1%',
        render: (text, record, index) => renderEl(
          <Icon onClick={() => onEditItem(record)} type="eye" style={{ cursor: 'pointer',paddingRight:'25px',lineHeight:'38px' }}/>,
          record,
          index
        ),
      },
