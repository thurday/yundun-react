  ...
  render() {
    ...
    return (
      <div className={classnames(styles.progress, className)}>
        {title ? <div className={classnames(styles.header, headerClass)}><Text style={{cursor:'pointer'}} onClick={this.showIpList} data={title} /></div> : null}
